  ...
  programs.alacritty = {
    ...
    settings = {
      ...
      key_bindings = [
        ...
        # General QoL improvements https =//github.com/jwilm/alacritty/wiki/Keyboard-mappings#general-quality-of-life-improvements
        {
          key = "Comma";
          mods = "Command";
          command = {
        ...
        # Swedish (sv_SE) https =//github.com/jwilm/alacritty/wiki/Keyboard-mappings#swedish-sv_se
        {
          key = "Key1";
          mods = "Alt";
          chars = "\\xA9";
