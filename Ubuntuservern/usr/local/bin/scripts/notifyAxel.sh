...
ssh -i $key -p512 axel@192.168.0.183 "DISPLAY=:0; XAUTHORITY=/home/axel/.Xauthority; export DISPLAY XAUTHORITY; notify-send '"$TR_TORRENT_NAME" är klar' '"$TR_TORRENT_NAME" laddades ner till "$TR_TORRENT_DIR"' -i /usr/local/bin/transgui.png"
