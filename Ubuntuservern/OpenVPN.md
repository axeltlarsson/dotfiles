# Setting up OpenVPN server for VPN access outside of local network
...
## Todo
* Fix so that it is actually useful, i.e. bridging since I cannot access the local network without that.
* Unified client profile that makes setting up new clients easier
